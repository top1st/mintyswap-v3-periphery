...
contract QuoterV2 is IQuoterV2, IMintyswapV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IMintyswapV3Pool;
    ...
    function MintyswapV3SwapCallback(
        ...
        IMintyswapV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IMintyswapV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
